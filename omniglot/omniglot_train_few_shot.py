...
def main():
    ...
    filename="omniglot_train_fewshot_"+str(year)+'_'+str(month)+'_'+str(day)+".txt"
        ...
        for episode in range(EPISODE):
            ...
            if (episode+1)%5000 == 0:
                ...
                for i in range(TEST_EPISODE):
                    ...
                    rewards = [1 if predict_labels[j].cuda()==test_labels[j].cuda() else 0 for j in range(CLASS_NUM*SAMPLE_NUM_PER_CLASS)]
                ...
                newcontext="test accuracy:  "+str(test_accuracy)+'\n'
                f.write(newcontext)
                ...
                if test_accuracy > last_accuracy:
                    ...
                    newcontext="save networks for episode:  "+str(episode)+'\n'
                    f.write(newcontext)
