...
import numpy as np
import task_generator_vid as tg
import os
import math
import argparse
import scipy as sp
        ...
        for episode in range(EPISODE):
            ...
            if episode%1000 == 0:
                ...
                if test_accuracy > last_accuracy:
                    ...
                    # save networks
                    torch.save(feature_encoder.state_dict(),str("./model/ucf_feature_encoder_c3d_8frame" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                    torch.save(relation_network.state_dict(),str("./model/ucf_relation_network_c3d_8frame"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
