        ...
        for episode in range(EPISODE):
            ...
            if episode%1000 == 0:
                ...
                if test_accuracy > last_accuracy:
                    ...
                    # save networks
                    torch.save(feature_encoder.state_dict(),str("./models/ucf_feature_encoder_c3d_8frame_lian" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                    torch.save(relation_network.state_dict(),str("./models/ucf_relation_network_c3d_8frame_lian"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
